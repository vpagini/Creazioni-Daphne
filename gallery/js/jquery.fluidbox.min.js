					...
					if($(this).data('fluidbox-state') === 0 || !$(this).data('fluidbox-state')) {
						...
						$('<img />', {
							...
							// Preload ghost image
                             ...
                             //HO AGGIUNTO QUESTO CHE RENDA OVERFLOW VISIBLE QUANDO APRE IL GHOST (LA ROBA CHE CONTIENE L'IMMAGINE) BY LEO
                            setTimeout( function(){ 
                                $(".resizer").css("overflow", "visible");
                                //E ANCHE QUESTA CHE NASCONDA IL FOOTER
                        ...
                        //HO AGGIUNTO QUESTO CHE RENDA OVERFLOW DI NUOVO HIDDEN QUANDO CHIUDE IL GHOST (LA ROBA CHE CONTIENE L'IMMAGINE) BY LEO
                            $(".resizer").css("overflow", "hidden");
                        //che riappaia il footer!
